...
export default function CoffeeProductsPage() {
  ...
  const handlePrev = () => {
    // Simple logic if you always want to step by 1 and wrap around
    setCurrentIndex(
        ...
        <div className="overflow-hidden">
          ...
          <div className="flex justify-center gap-6">
            ...
            {visibleProducts.map((product) => (
              <div
                key={product.id}
                className="border border-black rounded-xl overflow-hidden relative flex flex-col bg-[#f0e0c8] group w-80 flex-shrink-0"
              >
                {/* Card Image */}
